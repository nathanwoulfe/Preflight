...
namespace Preflight.Parsers
{
    ...
    public class PreflightValueParser
    {
        private readonly IMessenger _messenger;
        private readonly IPluginExecutor _pluginExecutor;

        public PreflightValueParser(IMessenger messenger, IPluginExecutor pluginExecutor)
        {
        ...
        /// <returns></returns>
        public string GetLabel(string propertyName, string innerPropertyName, string rowName = "", int index = 0)
        {
            return index > 0 ?
        ...
        public void SendRemoveResponse(string name, string label)
        {
