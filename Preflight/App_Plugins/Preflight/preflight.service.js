(function () {
  ...
  function preflightService($http, umbRequestHelper) {
    ...
    var urlBase = '/umbraco/backoffice/preflight/api/';
    var helpText = [
      ...
      '<h5>The algorithm</h5>',
      '<p><i>RE = 206.835 - (1.015 x ASL) - (84.6 x ASW)</i></p>',
    ...
    var service = {
      ...
      check: function (id) {
        return this.request('GET', urlBase + 'check/' + id);
      },

      getSettings: function () {
        return this.request('GET', urlBase + 'getSettings');
      },
      saveSettings: function (settings) {
        return this.request('POST', urlBase + 'saveSettings', settings)
      },

      // return some static text values
